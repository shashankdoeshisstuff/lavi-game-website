...
export const metadata: Metadata = {
  ...
  description:
    'Axenet IT Services is a premier game development studio creating cutting-edge gaming experiences for players worldwide.',
  icons: {
    icon: [
  ...
  return (
    <html lang="en" className="dark">
      <body className={`${satoshi.variable} font-sans`}>
        {/* Premium Capsule Pattern Background */}
